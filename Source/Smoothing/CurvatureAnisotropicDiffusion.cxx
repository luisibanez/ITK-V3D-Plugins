...
Q_EXPORT_PLUGIN2(CurvatureAnisotropicDiffusion, ITKCurvatureAnisotropicDiffusionPlugin)

QStringList ITKCurvatureAnisotropicDiffusionPlugin::menulist() const
{
	return QStringList() << QObject::tr("ITK CurvatureAnisotropicDiffusion Filter ...");
}
...
public:
	void Execute(const QString &arg, Image4DSimple *p4DImage, QWidget *parent)
	{
		...
		//------------------------------------------------------------------
		//setup filter: Curvature Flow Anisotropic Diffusion
		typedef itk::CurvatureFlowImageFilter<ImageType_mid,ImageType_mid> AniFilterType;
